...
<body>
  ...
  <?php
      ...
      include 'views/modules/modals/centro_costos.php';
...
<script type="text/javascript">
        $(document).ready(function(){
            ...
            {
                $("#formulario")[0].reset();
                $(".modal-title").text("Crear Centro de Costos");
                $("#action").val("Crear");
                $("#operacion").val("Crear");
		    ...
		    if(nombres != '' && codigo != '' )
                {
                    $.ajax({
                    url: base_url + "/assets/ajax/centro_costos.php?op=guardar&cliente=" + cliente_id,
                    method: 'POST',
            ...
            $.ajax({
                url:"/assets/ajax/centro_costos.php?op=buscar",
                method:"POST",
            ...
            $(document).on('click', '.borrar', function(){
                ...
                {
                    $.ajax({
                        url:base_url+"/assets/ajax/centro_costos.php?op=eliminar",
                        method:"POST",
                        data:{id_usuario:id_usuario},
                        success:function(data)
                        {
            ...
            //dataTable
             ...
             var dataTable = $('#tblcentrocostos').DataTable({
                ...
                "order":[],
                "ajax":{
                    url: base_url+"/assets/ajax/centro_costos.php?op=centro_costos",
                    type: "POST"
                },
                "columnsDefs":[
                    {
    ...
    // ======== CARGAR CLIENTES ===========
$.ajax({
    url: base_url + "/assets/ajax/centro_costos.php?op=clientes",
    type: "POST",
    dataType: "json",
    success: function(data) {
...
$('#clientes').on('change', function() {
    ...
    dataTable.ajax.url(base_url + "/assets/ajax/centro_costos.php?op=centro_costos&cliente=" + cliente_id).load();
});
