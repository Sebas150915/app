...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalUsuario" id="botonCrear"><i class="bi bi-plus-circle-fill"></i> Crear Local
                                    </button>
                                </div>
                            </div>
                        </div>
  ...
  <?php
      ...
      include 'views/modules/modals/locales.php';
...
<script type="text/javascript">
        $(document).ready(function(){
		    ...
		    if(nombres != '' )
                {
                    $.ajax({
                    url: base_url + "/assets/ajax/locales.php?op=guardar&cliente=" + cliente_id,
                    method: 'POST',
            ...
            $.ajax({
                url:"/assets/ajax/locales.php?op=buscar",
                method:"POST",
            ...
            $(document).on('click', '.borrar', function(){
                ...
                {
                    $.ajax({
                        url:base_url+"/assets/ajax/locales.php?op=eliminar",
                        method:"POST",
                        data:{id_usuario:id_usuario},
                        success:function(data)
                        {
            ...
            //dataTable
             ...
             var dataTable = $('#tblcentrocostos').DataTable({
                ...
                "order":[],
                "ajax":{
                    url: base_url+"/assets/ajax/locales.php?op=locales",
                    type: "POST"
                },
                "columnsDefs":[
                    {
    ...
    // ======== CARGAR CLIENTES ===========
$.ajax({
    url: base_url + "/assets/ajax/locales.php?op=clientes",
    type: "POST",
    dataType: "json",
    success: function(data) {
...
$('#clientes').on('change', function() {
    ...
    dataTable.ajax.url(base_url + "/assets/ajax/locales.php?op=locales&cliente=" + cliente_id).load();
});
